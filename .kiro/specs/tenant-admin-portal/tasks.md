...
- [x] 6. Scaffold Next.js 14 project at `web/`
...
- [x] 7. Create shared UI component library (`web/components/ui/`)
...
- [x] 8. Create typed API client and auth helpers (`web/lib/`)
...
- [x] 9. Implement Admin Dashboard page (`web/app/admin/page.tsx`)
...
- [x] 10. Implement admin sub-components (`web/app/admin/_components/`)
...
- [x] 11. Implement Self-Registration Portal page (`web/app/register/page.tsx`)
  - Client component (`'use client'`)
...
- [x] 12. Update nginx configuration for Next.js
...
- [x] 13. Add `web` service to docker-compose
